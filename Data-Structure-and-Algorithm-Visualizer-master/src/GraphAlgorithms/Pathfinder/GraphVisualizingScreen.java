...
public class GraphVisualizingScreen {
    ...
    public Color bgColor  = new Color(255,253,226);
    ...
    public GraphVisualizingScreen(){
        ...
        pp.setBackground(bgColor.darker());
        pp.setLayout(null);
        pp.setVisible(true);
        ...
        stBtn.setBackground(bgColor.darker());
        ...
        stBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (stBtn.isEnabled())
                    stBtn.setBackground(bgColor.darker().darker());
            }
        ...
        sBtn.setBackground(bgColor.darker());
        ...
        sBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (sBtn.isEnabled())
                    sBtn.setBackground(bgColor.darker().darker());
            }
        ...
        rBtn.setBackground(bgColor.darker());
        ...
        rBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (rBtn.isEnabled())
                    rBtn.setBackground(bgColor.darker().darker());
            }
