...
public class Staccc extends JPanel{
    ...
    public Color BGColor  = new Color(253,255,226);
    public Color blueColor  = new Color(0,26,110);
    public Color pinkColor  = new Color(226, 86, 186);
    public Color purpleColor  = new Color(128, 86, 226);
    public Color orangeColor  = new Color(141,11,65);
    ...
    public Staccc(){
        ...
        btnPanel.setBackground(new Color(94,84,161));
        ...
        resetBtn.setBackground(BGColor.darker());
        ...
        resetBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (resetBtn.isEnabled())
                    resetBtn.setBackground(BGColor.darker().darker());
            }
        ...
        startBtn.setBackground(BGColor.darker());
        ...
        startBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (startBtn.isEnabled())
                    startBtn.setBackground(BGColor.darker().darker());
            }
        ...
        popBtn.setBackground(BGColor.darker());
        popBtn.setFont(new Font(mainFont, Font.BOLD, 15));
        popBtn.setForeground(Color.black);
        ...
        popBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (popBtn.isEnabled())
                    popBtn.setBackground(BGColor.darker().darker());
            }
