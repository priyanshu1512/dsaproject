...
public class AlgorithmVisualizingScreen implements ActionListener {
    ...
    public AlgorithmVisualizingScreen(){
        ...
        generateArrayBtn.setBackground(bgcolor.darker());
        ...
        generateArrayBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (generateArrayBtn.isEnabled())
                    generateArrayBtn.setBackground(bgcolor.darker().darker());
            }
        ...
        jComboBox.setBackground(bgcolor.darker());
        ...
        jComboBox.setRenderer(new MyListCellRenderer(bgcolor.darker()));
