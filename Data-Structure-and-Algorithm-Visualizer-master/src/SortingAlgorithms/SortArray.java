...
public class SortArray extends JPanel {
    ...
    public Color sortedColor = new Color(167,212,119);
    ...
    public Color pinkColor  = new Color(240,90,126);
    public Color purpleColor  = new Color(108,72,197);
    ...
    public void GenerateRandomArray(int n){
        ...
        for (int i = 0; i<arrSize; i++){
            ...
            barColor[i] = new Color(255,170,170);
            sleep(2);
            Update();
        }
